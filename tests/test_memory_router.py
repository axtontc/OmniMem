...
def test_valid_payload():
    ...
    valid_data = {
        "embeddings": [
            {"id": "v1", "text": "hello", "vector": [0.1, 0.2, 0.3], "metadata": {"source": "test"}}
        ],
        "entities": [
            {"id": "e1", "label": "Person", "properties": {"name": "Alice"}}
        ],
        "relationships": [
            {"source_id": "e1", "target_id": "e2", "type": "KNOWS", "properties": {"since": 2021}}
        ]
    }
...
def test_invalid_entity_label():
    ...
    invalid_data = {
        "entities": [
            {"id": "e1", "label": "Invalid Label!", "properties": {}} # Label contains space and !, not allowed by pattern
        ]
    }
...
def test_sanitization():
    ...
    data = {
        "entities": [
            {"id": "e1", "label": "Person", "properties": {"name": "O'Connor", "age": 30}}
        ]
    }
